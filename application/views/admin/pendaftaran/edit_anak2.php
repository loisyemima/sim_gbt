         ...
         <div class="row">
           <div class="col-md-8">
             ...
             <div class="card card-primary">
               ...
               <!-- /.card-header -->
               <!-- form start -->
               <form action="<?= base_url('admin/pendaftaran/edit_anak2/' . $anak['anak_id']); ?>" method="post">
                 <div class="card-body">
                   ...
                   <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="kode" name="kode" placeholder="" value="<?php echo $anak['kode'] ?>" disabled>
                   </div>
                   <div class="form-group">
                     <label for="">Hari Penyerahan Anak</label>
                   ...
                   <div class="form-group">
                     ...
                     <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                       <input type="text" id="tgl_penyerahan" name="tgl_penyerahan" class="form-control datetimepicker-input" data-target="#reservationdate2" value="<?php echo $anak['tgl_penyerahan'] ?>" />
                   ...
                   <div class="form-group">
                     ...
                     <div class="input-group date" id="reservationdate3" data-target-input="nearest">
                       <input type="text" id="tgl_ttd" name="tgl_ttd" class="form-control datetimepicker-input" data-target="#reservationdate3" value="<?php echo $anak['tgl_ttd'] ?>" />
