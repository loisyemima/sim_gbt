         ...
         <div class="row">
           <div class="col-md-8">
             ...
             <div class="card card-primary">
               ...
               <!-- /.card-header -->
               <!-- form start -->
               <form action="<?= base_url('admin/pendaftaran/edit_baptiskod/' . $baptis['baptis_id']); ?>" method="post">
                 <div class="card-body">
                   ...
                   <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="kode" name="kode" placeholder="" value="<?php echo $baptis['kode'] ?>">
                   </div>
                   <div class="form-group">
